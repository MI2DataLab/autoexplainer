...
def load_model_and_data(number_of_images=2, dataset_name="Imagenette", path_to_img=""):
    ...
    if dataset_name == "Imagenette":
        model = torch.load("development/models/chosen_model_imagenette_pretrained_097.pth", map_location="cpu") #change to cpu
        ...
        model = torch.load("development/models/chosen_model_CXR_not_pretrained_092.pth", map_location="cpu") #change to cpu
        ...
        model = torch.load("development/models/chosen_model_KP_challenge1_not_pretrained_09.pth", map_location="cpu") #change to cpu
...
if __name__=="__main__":
    main(sys.argv)
    #how to run: python development/eden/script_for_eden.py Imagenette 2 development/data/kandinsky_1_challenge/ 1 development/eden/output_from_experiments
